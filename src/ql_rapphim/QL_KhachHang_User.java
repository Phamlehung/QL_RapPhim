 ...
 * @author Josheph
 */
public class QL_KhachHang_User extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel5);
        jLabel5.setBounds(30, 190, 100, 40);
        ...
        jPanel1.add(btnExit);
        btnExit.setBounds(310, 430, 90, 40);
        ...
        jScrollPane2.setBounds(20, 500, 700, 130);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QL_KhachHang_User.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QL_KhachHang_User().setVisible(true);
            }
        });
    }
